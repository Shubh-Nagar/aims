    ...
    <section className="surface-dark relative overflow-hidden">
      ...
      <div className="container relative pb-16 pt-6 md:pb-20">
        <Reveal className="mb-10 flex items-center justify-between gap-6">
          ...
          <p className="shrink-0 text-right font-display text-sm italic text-white/45">
            Twenty-seven acres, one working hospital.
          </p>
        </Reveal>
        <dl className="grid gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-4 lg:divide-x lg:divide-dashed lg:divide-white/15">
          {stats.map((stat, i) => (
            <Reveal key={stat.label} delay={i * 0.08} className="lg:pl-8 lg:first:pl-0">
              ...
              <dd className="mt-3 font-display text-[3.2rem] leading-none text-white">
